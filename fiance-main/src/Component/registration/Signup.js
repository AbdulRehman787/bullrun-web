...
function Signup  ()  {
  ...
  const handleSubmit = ()=>{
    ...
    if(values.name==="admin" || values.email === "admin@gmail" || values.password ==="dmvin34infvv"){
    ...
    <>
      <div className="containa">
        <div className="innerBox">
          ...
          <form>
                <InputControl label="Name" name='name' required placeholder="Enter Your Name"
          ...
          <b className='error'>{errmsg}</b>
            ...
            <p>Already Have an account <span><Link to="/registration/Login">Login</Link></span> </p>
          </div>
          </form>
        </div>
      </div>
