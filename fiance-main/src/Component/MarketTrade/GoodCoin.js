...
class GoodCoin extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      stockChartXValues: [],
      ...
      <div className='ibm'>
        <div className="card-group sq">
          ...
          <h1 className='title' id='mainprice'></h1>
            ...
            <h3 className='d-fle design'>Week <p className='dynnamicdata' id='price'>US$12.29 - US$12.39</p> </h3><hr />
            <h3 className='d-fle design'>52 Week <p className='dynnamicdata' id='price'>US$18.72 - US$12.39</p> </h3><hr />
            ...
            <h3 className='d-fle design'>Ceo <p className='dynnamicdata' >Ashleigh Ferran</p> </h3>
          </div>
        </div>
