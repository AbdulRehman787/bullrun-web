...
class MSFTCoin extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      stockChartXValues: [],
      ...
      <div className='ibm'>
        <div className="card-group sq">
          ...
          <h1 className='title' id='mainprice'></h1>
            <h2 id='profitprice'>+4.43 (0.43%)</h2>
            <h3 className='d-fle design'>Price <p className='dynnamicdata' id='price'></p> </h3><hr />
            <h3 className='d-fle design'>Week <p className='dynnamicdata' id='price'>US$281.49 - US$285.9</p> </h3><hr />
            <h3 className='d-fle design'>52 Week <p className='dynnamicdata' id='price'>US$245.50 - US$285.9</p> </h3><hr />
            ...
            <h3 className='d-fle design'>Ceo <p className='dynnamicdata' >Bill Gates</p> </h3>
          </div>
        </div>
